...
function thisLineItem($patient_id, $encounter_id, $rowcat, $description, $provider, $transdate, $qty, $amount, $irnumber = '')
{
...
<head>
    ...
    <title><?php echo xlt('Units Report'); ?></title>
...
<span class='title'><?php echo xlt('Report'); ?> - <?php echo xlt('Units'); ?></span>
  ...
  <table class='text'>
      <tr>
        ...
        ?>
          ...
          <td>
            <div class='checkbox'>
           <label><input type='checkbox' name='form_details'<?php echo ($form_details) ? ' checked' : 'checked'; ?>>
