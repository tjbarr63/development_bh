...
if (!empty($_POST['form_csvexport'])) {
    ...
    header("Content-Disposition: attachment; filename=indiv.csv");
...
<title><?php echo xlt('Assignment List'); ?></title>
...
<span class='title'><?php echo xlt('Report'); ?> - <?php echo xlt('Assignment List'); ?></span>
...
<form name='theform' id='theform' method='post' action='indiv.php' onsubmit='return top.restoreSession()'>
